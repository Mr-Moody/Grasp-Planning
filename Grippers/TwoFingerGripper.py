...
class TwoFingerGripper(Gripper):
    ...
    def graspObject(self, object:GameObject, grasp_offset=None) -> None:
        ...
        p.changeDynamics(object.id, -1, lateralFriction=0.6, rollingFriction=0.1, spinningFriction=0.1)
        p.changeDynamics(self.id, -1, lateralFriction=0.6, rollingFriction=0.1, spinningFriction=0.1)
